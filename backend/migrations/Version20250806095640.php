 ...
 */
final class Version20250806095640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE constitute (id INT AUTO_INCREMENT NOT NULL, food_id INT DEFAULT NULL, dish_id INT DEFAULT NULL, meal_id INT NOT NULL, food_quantity DOUBLE PRECISION DEFAULT NULL, dish_quantity DOUBLE PRECISION DEFAULT NULL, INDEX IDX_861C0FF1BA8E87C4 (food_id), INDEX IDX_861C0FF1148EB0CB (dish_id), INDEX IDX_861C0FF1639666D6 (meal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE food (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, protein DOUBLE PRECISION NOT NULL, carbs DOUBLE PRECISION NOT NULL, fat DOUBLE PRECISION NOT NULL, calories DOUBLE PRECISION NOT NULL, status VARCHAR(20) DEFAULT \'active\' NOT NULL, INDEX IDX_D43829F7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
